...
package de.flintfabrik.starling.display
{
	...
	public class FFParticleSystem extends DisplayObject implements IAnimatable
	{
		...
		private function addedToStageHandler(e:SEvent):void
		{
		...
		private function initInstance(config:SystemOptions):void
		{
			...
			addEventListener(SEvent.ADDED_TO_STAGE, addedToStageHandler);
		...
		private function complete():void
		{
			...
			{
				mCompleted = true;
				dispatchEventWith(starling.events.SEvent.COMPLETE);
			}
		}
		...
		public override function dispose():void
		{
			...
			removeEventListener(starling.events.SEvent.ADDED_TO_STAGE, addedToStageHandler);
			stop(true);
			mBatched = false;
		...
		public function stop(clear:Boolean = false):void
		{
			...
			if (clear)
			{
				...
				dispatchEventWith(starling.events.SEvent.CANCEL);
			}
		}
