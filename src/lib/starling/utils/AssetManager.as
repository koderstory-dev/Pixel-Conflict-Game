package starling.utils
{
    ...
    [SEvent(name="texturesRestored", type="starling.events.Event")]
    ...
    public class AssetManager extends EventDispatcher
    {
        ...
        public function purgeQueue():void
        {
            ...
            dispatchEventWith(SEvent.CANCEL);
        }
                                         ...
                                         onProgress:Function, onComplete:Function):void
        {
            ...
            addEventListener(SEvent.CANCEL, cancel);
            ...
            function process(asset:Object):void
            {
                    ...
                    texture.root.onRestore = function():void
                    {
                        ...
                        loadRawAsset(rawAsset, null, function(asset:Object):void
                        {
                            ...
                            if (mNumLostTextures == mNumRestoredTextures)
                                dispatchEventWith(SEvent.TEXTURES_RESTORED);
                        });
                    };
                ...
                removeEventListener(SEvent.CANCEL, cancel);
            }
        ...
        private function loadRawAsset(rawAsset:Object, onProgress:Function, onComplete:Function):void
        {
            ...
            else if (rawAsset is String)
            {
                ...
                urlLoader.addEventListener(SEvent.COMPLETE, onUrlLoaderComplete);
            ...
            function onUrlLoaderComplete(event:Object):void
            {
                ...
                urlLoader.removeEventListener(SEvent.COMPLETE, onUrlLoaderComplete);
                ...
                switch (extension.toLowerCase())
                {
                    ...
                    case "gif":
                        ...
                        loader.contentLoaderInfo.addEventListener(SEvent.COMPLETE, onLoaderComplete);
            ...
            function onLoaderComplete(event:Object):void
            {
                ...
                event.target.removeEventListener(SEvent.COMPLETE, onLoaderComplete);
