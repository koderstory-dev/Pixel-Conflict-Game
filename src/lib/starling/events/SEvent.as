...
package starling.events
{
    ...
    public class SEvent
    {
        ...
        public function SEvent(type:String, bubbles:Boolean=false, data:Object=null)
        {
            mType = type;
            mBubbles = bubbles;
            mData = data;
        ...
        /** @private */
        starling_internal static function fromPool(type:String, bubbles:Boolean=false, data:Object=null):SEvent
        {
            if (sEventPool.length) return sEventPool.pop().reset(type, bubbles, data);
            else return new SEvent(type, bubbles, data);
        }
        
        /** @private */
        starling_internal static function toPool(event:SEvent):void
        {
        ...
        /** @private */
        starling_internal function reset(type:String, bubbles:Boolean=false, data:Object=null):SEvent
        {
            mType = type;
            mBubbles = bubbles;
            mData = data;
