...
package starling.core
{
    ...
    internal class StatsDisplay extends Sprite
    {
        ...
        public function StatsDisplay()
        {
            ...
            addEventListener(SEvent.ADDED_TO_STAGE, onAddedToStage);
            addEventListener(SEvent.REMOVED_FROM_STAGE, onRemovedFromStage);
        }
        
        private function onAddedToStage():void
        {
            addEventListener(SEvent.ENTER_FRAME, onEnterFrame);
        ...
        {
            removeEventListener(SEvent.ENTER_FRAME, onEnterFrame);
        }
