    ...
    public class Starling extends EventDispatcher
    {
        ...
        private function initializeRoot():void
        {
            if (mRoot == null)
            {
                ...
                dispatchEventWith(starling.events.SEvent.ROOT_CREATED, false, mRoot);
            }
        }
        ...
        public function showStatsAt(hAlign:String="left", vAlign:String="top", scale:Number=1):void
        {
            if (mContext == null)
            {
                ...
                addEventListener(starling.events.SEvent.ROOT_CREATED, onRootCreated);
            }
            else
            {
            ...
            function onRootCreated():void
            {
                ...
                removeEventListener(starling.events.SEvent.ROOT_CREATED, onRootCreated);
            }
        }
