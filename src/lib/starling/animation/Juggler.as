    ...
    public class Juggler implements IAnimatable
    {
        ...
        public function add(object:IAnimatable):void
        {
            if (object && mObjects.indexOf(object) == -1) 
            {
                ...
                if (dispatcher) dispatcher.addEventListener(SEvent.REMOVE_FROM_JUGGLER, onRemove);
            }
        }
        ...
        public function remove(object:IAnimatable):void
        {
            ...
            var dispatcher:EventDispatcher = object as EventDispatcher;
            if (dispatcher) dispatcher.removeEventListener(SEvent.REMOVE_FROM_JUGGLER, onRemove);
        ...
        public function removeTweens(target:Object):void
        {
            ...
            for (var i:int=mObjects.length-1; i>=0; --i)
            {
                ...
                {
                    tween.removeEventListener(SEvent.REMOVE_FROM_JUGGLER, onRemove);
                    mObjects[i] = null;
                }
            }
        }
        ...
        public function delayCall(call:Function, delay:Number, ...args):IAnimatable
        {
            ...
            delayedCall.addEventListener(SEvent.REMOVE_FROM_JUGGLER, onPooledDelayedCallComplete);
            add(delayedCall);
        ...
        private function onPooledDelayedCallComplete(event:SEvent):void
        {
        ...
        public function tween(target:Object, time:Number, properties:Object):IAnimatable
        {
            ...
            tween.addEventListener(SEvent.REMOVE_FROM_JUGGLER, onPooledTweenComplete);
            add(tween);

            return tween;
        }
        
        private function onPooledTweenComplete(event:SEvent):void
        {
        ...
        private function onRemove(event:SEvent):void
        {
