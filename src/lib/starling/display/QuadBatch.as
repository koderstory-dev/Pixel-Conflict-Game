...
package starling.display
{
    ...
    public class QuadBatch extends DisplayObject
    {
        ...
        public function QuadBatch()
        {
            ...
            Starling.current.stage3D.addEventListener(SEvent.CONTEXT3D_CREATE, 
        ...
        {
            Starling.current.stage3D.removeEventListener(SEvent.CONTEXT3D_CREATE, onContextCreated);
            destroyBuffers();
