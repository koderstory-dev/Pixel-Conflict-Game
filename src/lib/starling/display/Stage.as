...
package starling.display
{
    ...
    [SEvent(name="resize", type="starling.events.ResizeEvent")]
    ...
    public class Stage extends DisplayObjectContainer
    {
        ...
        public function Stage(width:int, height:int, color:uint=0)
        {
            ...
            mHeight = height;
            mColor = color;
            mEnterFrameEvent = new EnterFrameEvent(SEvent.ENTER_FRAME, 0.0);
        ...
        {
            mEnterFrameEvent.reset(SEvent.ENTER_FRAME, false, passedTime);
        ...
        {
            if (eventType == SEvent.ENTER_FRAME && object == this)
            {
