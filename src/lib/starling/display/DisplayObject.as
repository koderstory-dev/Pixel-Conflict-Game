...
package starling.display
{
    ...
    public class DisplayObject extends EventDispatcher
    {
        ...
        public override function dispatchEvent(event:SEvent):void
        {
            if (event.type == SEvent.REMOVED_FROM_STAGE && stage == null)
        ...
        {
            if (type == SEvent.ENTER_FRAME && !hasEventListener(type))
            {
                addEventListener(SEvent.ADDED_TO_STAGE, addEnterFrameListenerToStage);
                addEventListener(SEvent.REMOVED_FROM_STAGE, removeEnterFrameListenerFromStage);
        ...
        public override function removeEventListener(type:String, listener:Function):void
        {
            ...
            if (type == SEvent.ENTER_FRAME && !hasEventListener(type))
            {
                removeEventListener(SEvent.ADDED_TO_STAGE, addEnterFrameListenerToStage);
                removeEventListener(SEvent.REMOVED_FROM_STAGE, removeEnterFrameListenerFromStage);
        ...
        public override function removeEventListeners(type:String=null):void
        {
            ...
            if (type == null || type == SEvent.ENTER_FRAME)
            {
                removeEventListener(SEvent.ADDED_TO_STAGE, addEnterFrameListenerToStage);
                removeEventListener(SEvent.REMOVED_FROM_STAGE, removeEnterFrameListenerFromStage);
                removeEnterFrameListenerFromStage();
