package gimdata.mvc.view.tutorial 
{
	 ...
	 * @author ...
	 */
	public class TutLevel9 extends IViewTutorial 
	{
		
		public function TutLevel9() 
		{
			super();
			
			m_dataText = [
				"The supply convoys that slowly walk through any terrains are our lifelines during this war. Enemies know that if they could cut those lifelines, they will be that much closer to victory. ",
				"Mission: Protect supply unit untill reach finish point. Use supply unit to heal wounded unit."/*,
			...
			var _img1:Image = new Image(Ast.img("tut9_1"));
			var _img2:Image = new Image(Ast.img("tut9_2"));
