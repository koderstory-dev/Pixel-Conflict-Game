package gimdata.mvc.view.tutorial 
{
	 ...
	 * @author ...
	 */
	public class TutLevel7 extends IViewTutorial 
	{
		
		public function TutLevel7() 
		{
			super();
			
			m_dataText = [
				"Everyone, we will sabotage enemy buildings. We have limited time and units. Use them to capture last building (enemy base)",
				"Mission: Capture enemy base. The guards never move unless we are close to them. Drag them outside their buildings."/*,
			...
			var _img1:Image = new Image(Ast.img("tut7_1"));
			var _img2:Image = new Image(Ast.img("tut7_2"));
