package gimdata.mvc.view.tutorial 
{
	 ...
	 * @author ...
	 */
	public class TutLevel5 extends IViewTutorial 
	{
		
		public function TutLevel5() 
		{
			super();
			
			m_dataText = [
				"Town Kidul is our steppin stone for repelling enemy forces. This time we prepare a large army to seize the town. Your mission is either to capture their basecamp or destroy all enemies.",
				"Mission: Capture basecamp or destroy them all. Defeat enemy within 10 turns. Capturing the basecamp will force the enemy to withdraw from the town and let you win."/*,
			...
			var _img1:Image = new Image(Ast.img("tut5_1"));
			var _img2:Image = new Image(Ast.img("tut5_2"));
